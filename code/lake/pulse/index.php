<?php 
$title = 'Instantaneous Release into a Lake';
...
<?php print $title; ?>
	...
	<div class="row">
		<div class="small-12 columns">
			<form class="lake-pulse-form fate-form" action="../../lake/pulse/" method="get" id="lake-pulse-form" accept-charset="UTF-8">
				<fieldset class="fieldset">
					<legend> Step 1</legend> Manually convert input data to metric units: meters, mg/L, or &mu;Ci/L. 
				</fieldset>
				<fieldset class="fieldset">
				...
				<fieldset class="fieldset">
					<legend> Step 5: Initial concentration of pollutant in the Lake</legend> <label for="c0" class="c0 with-units required"> 
					C<sub>0</sub> = 
					<input type="text" id="c0" name="c0" value="12.25" size="5" maxlength="128" class="c0 required" required="required" aria-required="true" />
					</label> <label for="massType" class="massType"> 
					<select id="massType" name="massType" class="massType">
						<option value="mg/L" selected="selected">mg/L</option>
						<option value="&mu;Ci/L">&mu;Ci</option>
					</select>
					</label> 
				</fieldset>
				<fieldset class="fieldset">
				...
				<fieldset class="fieldset">
					...
					<div class="equation">
						\[C_{(t)} = C_0*e^{-(\frac{Qe}{V}+k)t}\ \ or\ \ C_{(t)}=C_0*e^{-&beta;t} \] 
					</div>
...
<script src="lakePulse.js?v=5"></script>
<?php
