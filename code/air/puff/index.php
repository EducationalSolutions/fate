...
<?php print $title; ?>
	...
	<div class="row">
		<div class="small-11 small columns">
			<p>
				The three dimensional nature of our atmosphere often makes tracking airborne pollutants very difficult.  This section of Fate allows you to estimate the concentration of a pollutant at a specific distance downwind from an instantaneous release of pollutant.  An example of a source that might release this type of pollutant puff is the explosion of an ammonia tank.
			</p>
		</div>
	</div>
	<div class="row">
			...
			<form class="air-puff-form fate-form" action="../../air/puff/" method="get" id="air-puff-form" accept-charset="UTF-8">
              ...
              <h4 class="text-center">Horizontal</h4>
					...
					<div class="row s-values">
						<div class="a-value SXGraph columns small-2">Unstable:
						</div>
						<div class="c-value SXGraph columns small-2">Neutral:
						</div>
						<div class="e-value SXGraph columns small-2">Stable:
						</div>
						<div class="a-value SZGraph columns small-2">Unstable:
						</div>
						<div class="c-value SZGraph columns small-2">Neutral:
						</div>
						<div class="e-value SZGraph columns small-2">Stable:
						</div>
					</div>
				</fieldset>
				<fieldset class="fieldset">
				...
				<!--
				<fieldset class="fieldset">
				  <legend> Update Plots</legend>
				  <p>Because the air calculations can be somewhat intense and sometimes hang the interface, we don't replot on demand.  If you would like to see updated plots, click this fun button:</p>
				  <input type="submit" value="Update Plots" class="update-plots" />
				</fieldset>
				-->
				<fieldset class="fieldset">
